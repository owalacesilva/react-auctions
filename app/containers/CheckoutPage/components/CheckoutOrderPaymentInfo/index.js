...
function CheckoutOrderPaymentInfo({ order: { pagamento: orderPayment } }) {
  return (
    <div>
      <div className="compra-pagamento">
        <div className="pagamentoQrCode text-center">
            ...
            <div className="card-body">
              <div className="row justify-content-center mb-2">
                ...
                <div className="col-12 my-2">
                  ...
                  >
                    Este pagamento só pode ser realizado dentro do tempo, após
                    este período, caso o pagamento não for confirmado os números
                ...
                <div className="col-12">
                  ...
                  >
                    <i className="bi bi-check-all" /> Já fiz o pagamento
                  </button>
                </div>
              </div>
              <hr />
                ...
                <div className="col-12 pb-3">
                  <div className="font-xss">
                    ...
                    <div>
                      ...
                      Code, escaneie o código ao lado e confirme o pagamento.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="alert alert-info p-2 font-xss mb-2">
            <i className="bi bi-info-circle" /> Após o pagamento aguarde até 5
            minutos para a confirmação, caso já tenha efetuado o pagamento,
            clique no botão <b>Já fiz o pagamento</b>.
          </div>
        </div>
      </div>
    </div>
